        ...
        <form action="{{route('customer-update-profile', $employee->id)}}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="user_mobile_number" name="user_mobile_number" placeholder="Enter Mobile Number" maxlength="11" required value="{{ old('user_mobile_number') ??$employee->mobile_number }}">
                </div>
                <div class="form-group">
