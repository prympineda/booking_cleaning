            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="user_mobile_number" name="user_mobile_number" placeholder="Enter Mobile Number" maxlength="10" required value="{{ old('user_mobile_number') ??$employee->mobile_number }}">
                    </div>
